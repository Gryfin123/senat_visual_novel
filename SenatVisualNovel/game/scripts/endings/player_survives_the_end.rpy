label end_player_survives_the_end:

    scene bg home
    with fade

    "You leave destruction and pain behind you."

    "You have no idea what actually happend there, but hey, you are alive. Unlike all the people that did not manage to escape."
